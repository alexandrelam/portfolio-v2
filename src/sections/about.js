      ...
      <div className="about container">
        ...
        <div className="content">
          <p>
            ...
            <strong>Mines-Télécom</strong> Lille Douai. Mon projet est de mener
            des études dans le domaine de{" "}
            <strong>l'ingénierie informatique</strong> et plus précisément dans
            le développement.
          </p>
          <p>
          ...
          <p>
            ...
            voyager et passer du temps avec mes amis. Je suis aussi un
            enthousiaste de hardware et de clavier mécanique custom.
          </p>
          <p>
            Voici quelques{" "}
            <strong>technologies avec lesquelles j’ai travaillé</strong>{" "}
            récemment:
          </p>
